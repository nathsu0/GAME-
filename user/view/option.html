            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="card ms-5 mt-2" style="width: 18rem;">
                        <img src="../img/kid.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                          <h5 class="card-title">Student</h5>
                          <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                          <a href="student/Code.html" class="btn btn-primary">Go somewhere</a>
                        </div>
                      </div>
                </div>
                <div class="col-sm-6">
                    <div class="card ms-5 mt-2" style="width: 18rem;">
                        <img src="../img/teacher.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                          <h5 class="card-title">Teacher</h5>
                          <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                          <a href="teacher/Teacheraccs.php" class="btn btn-primary">Go somewhere</a>
                        </div>
                      </div>
                </div>
              </div>
