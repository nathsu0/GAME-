...
<html lang="en">
  ...
  <script >//vaaaar
    ...
    <!---CREATE CSS-->
    <link rel="stylesheet" href="../../css/student/QA.css?v=<?php echo time(); ?>">
...
?>
    ...
    <script type="text/javascript"src="../../js/student/QA.js"></script>
    <script src="../../includes/student/background.js"></script>
  </body>
</html>